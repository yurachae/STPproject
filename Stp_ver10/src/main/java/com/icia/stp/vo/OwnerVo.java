...
public class OwnerVo {
	...
	public OwnerVo(String email, String password, String name, String phone_front, String phone_mid, String phone_end,
			String addr1, String addr2, String addr3, String prkplceno, int memberType, String authkey, int state,
			int point, int exchange, int balance, MeetyouallParkVo parking) {
		super();
		this.email = email;
	...
	public String toString() {
		return "OwnerVo [email=" + email + ", password=" + password + ", name=" + name + ", phone_front=" + phone_front
				+ ", phone_mid=" + phone_mid + ", phone_end=" + phone_end + ", addr1=" + addr1 + ", addr2=" + addr2
				+ ", addr3=" + addr3 + ", prkplceno=" + prkplceno + ", memberType=" + memberType + ", authkey="
				+ authkey + ", state=" + state + ", point=" + point + ", exchange=" + exchange + ", balance=" + balance
				+ ", parking=" + parking + "]";
	}
	...
	public void setMeetyouallpark(MeetyouallParkVo parking) {
		this.parking = parking;
	}
