...
<!-- Navigation -->
	...
	<script>
		...
		function parkingReserve() {
			...
			form.setAttribute("charset", "UTF-8");
			form.setAttribute("method", "POST");
			form.setAttribute("action", "../search/registerParingForm");

			document.body.appendChild(form);
			form.submit();
		}
		//환전 신청 내역
		function exchangeApplyList() {
			var form = document.createElement("form");
			form.setAttribute("charset", "UTF-8");
			form.setAttribute("method", "POST");
			form.setAttribute("action", "../payment/exchangeApplyList");
			document.body.appendChild(form);
			form.submit();
		}
		...
		function reserveManage() {
			...
			form.setAttribute("charset", "UTF-8");
			form.setAttribute("method", "POST");
			form.setAttribute("action", "../search/reserveList");
